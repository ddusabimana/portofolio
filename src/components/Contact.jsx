...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const mailtoLink = `mailto:petitmadjima@gmail.com?subject=Contact from ${name}&body=${encodeURIComponent(message)}\n\nFrom: ${name}\nEmail: ${email}`;
  ...
  const socialLinks = [
    ...
    { name: 'Email', url: 'mailto:petitmadjima@gmail.com', icon: '📧' },
  ];
